...
const TRANSLATIONS = {
  zh: {
    ...
    about_contact_body: "你可以通过 GitHub、X、flutterffi.github.io，或者页面左侧的两个 Gmail 地址联系我。",
    overview: "概览",
    posts: "文章",
    labels: "标签",
    all: "全部",
  ...
  en: {
    ...
    about_contact_body: "You can find me through GitHub, X, flutterffi.github.io, or the two Gmail addresses in the left rail.",
    overview: "Overview",
    posts: "Posts",
    labels: "Labels",
    all: "All",
